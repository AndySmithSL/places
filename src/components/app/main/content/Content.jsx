...
import ContentRouteLegs from "./routeLegs/ContentRouteLegs";
  ...
  render() {
    ...
    return (
      <div className="Content">
        ...
        {category.name === "Continents" && (
          <ContentContinents category={category} />
        )}
        {category.name === "Territory Types" && (
          <ContentTerritoryTypes category={category} />
        )}
        {category.name === "Territories" && (
          <ContentTerritories category={category} />
        )}
        {category.name === "Places" && <ContentPlaces category={category} />}
        {category.name === "Flags" && <ContentFlags category={category} />}
        {category.name === "Place Groups" && (
          <ContentPlaceGroups category={category} />
        )}
        {category.name === "Drives" && <ContentDrives category={category} />}
        {category.name === "Routes" && <ContentRoutes category={category} />}
        {category.name === "Route Legs" && (
          <ContentRouteLegs category={category} />
        )}
      </div>
    );
  }
