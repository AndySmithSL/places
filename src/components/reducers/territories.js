...
const requestTerritoriesReducer = (state) =>
  updateObject(state, { fetchingItems: true });

const receiveTerritoriesReducer = (state, action) =>
  updateObject(state, { fetchingItems: false, items: action.territories });

const filterTerritoriesReducer = (state, action) =>
  updateObject(state, { filter: action.filter });

const requestTerritoryReducer = (state, action) =>
  updateObject(state, { fetchingItem: true, itemId: action.id });

const receiveTerritoryReducer = (state, action) =>
  updateObject(state, { fetchingItem: false, item: action.territory });
